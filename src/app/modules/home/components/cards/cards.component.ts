...
export class CardsComponent {
  ...
  // Ao passar o mouse encima do elemento, ele verifica em que condição o id se encaixa e posteriormente remove a classe definida para cada condição!
  ...
  // Ao retirar o mouse de cima do elemento, ele verifica em que condição o id se encaixa e posteriormente adiciona a classe definida para cada condição!
